    ...
    animateVisualElement(visualElement, target, transition, delay2, animations2) {
      ...
      progress2.start(animateMotionValue("", progress2, [0, 1e3], {
        ...
        onUpdate: (latest) => {
          ...
          xValue == null ? void 0 : xValue.set(point.x);
          yValue == null ? void 0 : yValue.set(point.y);
...
function useVisualElement(Component2, visualState, props, createVisualElement, ProjectionNodeConstructor, isSVG) {
  ...
  const wantsHandoff = (0, import_react18.useRef)(Boolean(optimisedAppearId) && typeof window !== "undefined" && !((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) == null ? void 0 : _b.call(window, optimisedAppearId)));
...
//# sourceMappingURL=chunk-5E3PWSMC.js.map
